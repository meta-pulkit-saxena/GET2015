 ...
 * This class implements the connection pool for the query system.
 */

package com.meta.vehicledekho.db;
...
public class ConnectionPool {
	private final String DATABASE_URL = "jdbc:mysql://localhost:3306/vehicle";       
	...
	private void initialize() throws MetaVehicleSystemException {
		...
		while (!isConnectionPoolFull()) {									// Adding new connection objects in pool until full.
			try {
				...
				System.out.println("Error in creating a new connection object" + e.getMessage());
				throw e;
			}
	...
	public Connection getConnection() throws MetaVehicleSystemException {
		...
		try {
			...
			e.printStackTrace();
			throw new MetaVehicleSystemException("Error occurred");
		}
