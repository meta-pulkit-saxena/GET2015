...
public class FahrenheitToCelsiusServiceLocator extends org.apache.axis.client.Service implements com.metacube.webservice.FahrenheitToCelsiusService {
    ...
    private java.lang.String FahrenheitToCelsius_address = "http://localhost:8080/WebService/services/FahrenheitToCelsius";
    ...
    public com.metacube.webservice.FahrenheitToCelsius getFahrenheitToCelsius() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.webservice.FahrenheitToCelsius getFahrenheitToCelsius(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.webservice.FahrenheitToCelsiusSoapBindingStub _stub = new com.metacube.webservice.FahrenheitToCelsiusSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.webservice.FahrenheitToCelsius.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.webservice.FahrenheitToCelsiusSoapBindingStub _stub = new com.metacube.webservice.FahrenheitToCelsiusSoapBindingStub(new java.net.URL(FahrenheitToCelsius_address), this);
                _stub.setPortName(getFahrenheitToCelsiusWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.metacube.com", "FahrenheitToCelsiusService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.metacube.com", "FahrenheitToCelsius"));
        }
